...
ops.fbinary             = 'D:\DATA\Spikes\testing\test_binary.dat'; % will be created for 'openEphys'		
ops.fproc               = 'D:\DATA\Spikes\testing\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = 'D:\DATA\Spikes\testing\'; % 'openEphys' only: where raw files are		
		
ops.fs                  = 24414;        % sampling rate		(omit if already in chanMap file)
ops.NchanTOT            = 6;           % total number of channels (omit if already in chanMap file)
ops.Nchan               = 6;           % number of active channels (omit if already in chanMap file)
...
% ops.chanMap             = 'D:\DATA\Spikes\testing\chanMap.mat'; % make this file using createChannelMapFile.m		
